...
class ResourcesApi(object):
    ...
    def list_inference_service_resources(self, namespace, name, **kwargs):  # noqa: E501
        ...
        >>> thread = api.list_inference_service_resources(namespace, name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str namespace: Namespace provides a logical grouping of resources (required)
        :param str name: Name identifies a machine learning model (required)
        ...
        if kwargs.get('async_req'):
            return self.list_inference_service_resources_with_http_info(namespace, name, **kwargs)  # noqa: E501
        else:
            (data) = self.list_inference_service_resources_with_http_info(namespace, name, **kwargs)  # noqa: E501
            return data

    def list_inference_service_resources_with_http_info(self, namespace, name, **kwargs):  # noqa: E501
        """list_inference_service_resources  # noqa: E501

        list objects of kind resource for Inference Service  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_inference_service_resources_with_http_info(namespace, name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['namespace', 'name', 'endpoint', 'component']  # noqa: E501
    ...
    def list_seldon_deployment_resources(self, namespace, name, **kwargs):  # noqa: E501
        """list_seldon_deployment_resources  # noqa: E501

        list objects of kind resource for Seldon Deployment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_seldon_deployment_resources(namespace, name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_seldon_deployment_resources_with_http_info(namespace, name, **kwargs)  # noqa: E501
        else:
            (data) = self.list_seldon_deployment_resources_with_http_info(namespace, name, **kwargs)  # noqa: E501
            return data

    def list_seldon_deployment_resources_with_http_info(self, namespace, name, **kwargs):  # noqa: E501
        """list_seldon_deployment_resources  # noqa: E501

        list objects of kind resource for Seldon Deployment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_seldon_deployment_resources_with_http_info(namespace, name, async_req=True)
        >>> result = thread.get()
