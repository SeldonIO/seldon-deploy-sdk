...
class JobsApi(object):
    ...
    def get_deployment_batch_job(self, name, namespace, workflow_name, **kwargs):  # noqa: E501
        """get_deployment_batch_job  # noqa: E501

        Get details on the seldondeployment's batch job  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_deployment_batch_job(name, namespace, workflow_name, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str name: Name identifies a resource (required)
        :param str namespace: Namespace provides a logical grouping of resources (required)
        :param str workflow_name: WorkflowName identifies a workflow name (required)
        :return: BatchJob
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_deployment_batch_job_with_http_info(name, namespace, workflow_name, **kwargs)  # noqa: E501
        else:
            (data) = self.get_deployment_batch_job_with_http_info(name, namespace, workflow_name, **kwargs)  # noqa: E501
            return data

    def get_deployment_batch_job_with_http_info(self, name, namespace, workflow_name, **kwargs):  # noqa: E501
        """get_deployment_batch_job  # noqa: E501

        Get details on the seldondeployment's batch job  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_deployment_batch_job_with_http_info(name, namespace, workflow_name, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['name', 'namespace', 'workflow_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('workflow_name' not in params or
            ...
            raise ValueError("Missing the required parameter `workflow_name` when calling `get_deployment_batch_job`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/namespaces/{namespace}/seldondeployments/{name}/batchjobs/{workflowName}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
