...
class AlertingServiceApi(object):
    ...
    def alerting_service_list_alerts(self, **kwargs):  # noqa: E501
        """List currently firing alerts.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_service_list_alerts(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :return: V1ListAlertsResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.alerting_service_list_alerts_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.alerting_service_list_alerts_with_http_info(**kwargs)  # noqa: E501
            return data

    def alerting_service_list_alerts_with_http_info(self, **kwargs):  # noqa: E501
        """List currently firing alerts.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.alerting_service_list_alerts_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method alerting_service_list_alerts" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='V1ListAlertsResponse',  # noqa: E501
    ...
    def alerting_service_trigger_test_alert_with_http_info(self, use_metrics_flow, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method alerting_service_trigger_test_alert" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='V1TriggerTestAlertResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
