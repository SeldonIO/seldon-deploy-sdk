...
class DriftDetectorApi(object):
    ...
    def create_drift_detector_inference_service(self, name, namespace, detector_data, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_drift_detector_inference_service(name, namespace, detector_data, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_drift_detector_inference_service_with_http_info(name, namespace, detector_data, **kwargs)  # noqa: E501
        else:
            (data) = self.create_drift_detector_inference_service_with_http_info(name, namespace, detector_data, **kwargs)  # noqa: E501
            return data

    def create_drift_detector_inference_service_with_http_info(self, name, namespace, detector_data, **kwargs):  # noqa: E501
        """create_drift_detector_inference_service  # noqa: E501

        Create the specified Inference Service Drift Detector  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_drift_detector_inference_service_with_http_info(name, namespace, detector_data, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method create_drift_detector_inference_service" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `create_drift_detector_inference_service`")  # noqa: E501
        ...
        if ('detector_data' not in params or
            ...
            raise ValueError("Missing the required parameter `detector_data` when calling `create_drift_detector_inference_service`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/namespaces/{namespace}/inferenceservices/{name}/monitor/drift-detector', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def delete_drift_detector_inference_service_with_http_info(self, name, namespace, detector_name, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_drift_detector_inference_service" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `delete_drift_detector_inference_service`")  # noqa: E501
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params or
                params['namespace'] is None):
        ...
        return self.api_client.call_api(
            '/namespaces/{namespace}/inferenceservices/{name}/monitor/drift-detector/{detectorName}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def read_drift_detector_inference_service_with_http_info(self, name, namespace, detector_name, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method read_drift_detector_inference_service" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `read_drift_detector_inference_service`")  # noqa: E501
        # verify the required parameter 'namespace' is set
        if ('namespace' not in params or
                params['namespace'] is None):
        ...
        return self.api_client.call_api(
            '/namespaces/{namespace}/inferenceservices/{name}/monitor/drift-detector/{detectorName}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
