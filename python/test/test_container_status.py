...
from seldon_deploy_client.models.container_status import ContainerStatus  # noqa: E501
...
class TestContainerStatus(unittest.TestCase):
    ...
    def testContainerStatus(self):
        ...
        # model = seldon_deploy_client.models.container_status.ContainerStatus()  # noqa: E501
        pass
