...
from seldon_deploy_client.models.inference_service_list import InferenceServiceList  # noqa: E501
...
class TestInferenceServiceList(unittest.TestCase):
    ...
    def testInferenceServiceList(self):
        ...
        # model = seldon_deploy_client.models.inference_service_list.InferenceServiceList()  # noqa: E501
        pass
