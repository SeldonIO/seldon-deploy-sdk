...
from seldon_deploy_client.models.hpa_scaling_rules import HPAScalingRules  # noqa: E501
...
class TestHPAScalingRules(unittest.TestCase):
    ...
    def testHPAScalingRules(self):
        ...
        # model = seldon_deploy_client.models.hpa_scaling_rules.HPAScalingRules()  # noqa: E501
        pass
