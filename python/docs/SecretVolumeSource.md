...
**optional** | **bool** | optional field specify whether the Secret or its keys must be defined +optional | [optional] 
**secret_name** | **str** | secretName is the name of the secret in the pod&#39;s namespace to use. More info: https://kubernetes.io/docs/concepts/storage/volumes#secret +optional | [optional] 
